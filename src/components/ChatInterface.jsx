...
function ChatInterface() {
  ...
  }, [userId, socketConnected, fetchChatHistory]);
  ...
  const handleSend = async (e) => {
    ...
    try {
      ...
      setMessages((prev) => {
        ...
        const botExists = prev.some(
          (msg) =>
            msg.text === botMessage.text &&
            Math.abs(new Date(msg.timestamp) - new Date(botMessage.timestamp)) <
              3000 &&
            msg.senderType === "bot"
        );
